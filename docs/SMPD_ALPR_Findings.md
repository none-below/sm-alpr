...
*Revised April 22, 2026: Updated PRA W012320 [32] — city confirmed "no responsive records" on restated search-activity-audit request. Updated PRA W012373 [34] — city confirmed the 2020 Service Agreement is the only written authorization responsive to the Nov 2022 – Aug 2023 gap period, and "no responsive records" on deployment/operation authorizations for that period.*
...
2. **No documented audits for 13+ years.** Policy 462/463 required audits "as described in SOP 205." SOP 205 specified quarterly operator audits across all platforms and quarterly end-user audits for NCRIC — including review of search justifications and case number entries. The end-user audit criteria were never extended to Flock (see §1). O’Keefe confirmed no audit records of any kind exist before December 2025. She stated audits occurred through "roundtable discussions," but a PRA for meeting records returned no responsive documents. The audits that began in December 2025 review sharing configuration, not search activity compliance. A subsequent PRA specifically requesting search activity records confirmed these are the only audits that exist (see §1). [32]
...
- The Flock transparency page for San Mateo listed 68 devices as of February 18, 2026 [10]; reduced to 66 after the department asked Flock to remove 2 decommissioned units [21]. The department's Camera Manager reports 80 [20]. The difference includes 12 Picard devices — AI edge computing hardware that does not appear in any invoice, contract, amendment, or council presentation [5] [6].
...
| Jan 2022 | Council goal-setting packet, p. 7 | 22 | Progress update: "22 Flock ALPRs deployed" — 10 beyond contract scope | [35] |
| Aug 2023 | Staff report / MSA order form | 40 | "forty LPRs, to be deployed" — presented as new; absorbed the existing 12 (31 Falcon + 9 Falcon) | [8] [5] |
...
| Feb 2026 | Flock Camera Manager (PRA) | 80 | 78 healthy + 2 offline; includes 12 Picard + 1 Avicore not in any contract | [20] |
...
- The original MSA (August 2023) was signed by Chief Barberini and Flock’s General Counsel. No city attorney signature appears on the original MSA [5, signature page]. Two months later, the AG Bulletin guided agencies to review vendor agreements for exactly this kind of provision [18]. Amendment No. 1 (March 2024) added city attorney review [6, signature page] — but did not modify § 5.3.
...
- The department cited § 1798.90.55(b) to deny a resident’s request for their own vehicle’s ALPR records [26] and to withhold aggregate search compliance data from the public [32]. The same statute prohibits sharing ALPR data with non-public entities [12]. University of the Pacific — a private institution — had access to SMPD’s ALPR data during this period [10].
...
- For regional context: Mountain View PD discovered in January 2026 that approximately 240 agencies had access to its ALPR data — against an intended list of roughly 75. Mountain View suspended its Flock program in response [13]. SMPD’s transparency portal lists 283 agencies [10]. Whether SMPD intended this scope is unknown — no records of access determinations were produced [16], so the department cannot demonstrate which agencies it deliberately chose to authorize.
...
- PRA W012570 (closed April 22, 2026) produced the Flock platform event log that the W012328 response had stated did not exist [50] [31]. The log identifies the actors in two events for University of the Pacific: a 2/12/2026 `create networkShare` event by Phoenix O'Rourke (an SMPD member; permissions `feedView`), and a 2/28/2026 `delete networkShare` event by Lt. Steve Casazza (the documented Flock Committee administrator [17]; permissions `Search, VMS, Hotlist`). Per Policy 463.8(b), only the ALPR Committee Captain or a documented authorized designee may approve external-agency access changes [3]; PRA W012174 produced no records documenting any 463.8(b) designation framework [16]. No reading of the records is consistent with 463.8(b) compliance: if Casazza is the ALPR Committee Captain (the most plausible reading given his July 2025 Flock Committee assignment [17]), O'Rourke's 2/12 action lacked the required authorization; if not, both actions did. The 2/12 addition placed UOP — an entity that does not qualify as a public agency under § 1798.90.5(f) [12] [29] — on the access list two months after Policy 463.8(b) took effect [3], indicating the broken approval process produced unauthorized, non-compliant additions even after the December 2025 policy revision.
...
- Lt. Steve Casazza was assigned as Flock Committee administrator in July 2025 [17] — five months before the first audit memo, two years into the Flock contract, and thirteen years after the department's first ALPR policy (Policy 462, 2012) [11].

- SOP 205 copyright date: November 10, 2025. Policy 463 copyright date: December 12, 2025. Policy 463 effective date: December 22, 2025. First documented audits: December 2025 [11]. Procedure 1102 (ALPR Systems) copyright date: March 6, 2026 [39]. The SOP 205 "update" changed only the copyright date — substantive content unchanged since February 2021 (see §1) [19]. The policy revision, first audits, and new operational procedure all occurred within approximately four months. [4, footer] [3, footer] [11] [39]

- Procedure 1102 (ALPR Systems), published March 6, 2026, is a new Lexipol operational procedure for Real Time Information Center (RTIC) personnel [39]. It defines duties for alert evaluation, call creation, license plate querying, and vehicle description searches. It directs RTIC personnel to use the ALPR system "when searching for vehicles associated to crimes or life or death emergencies" and to document matches as "possible plate matches only." The procedure is prescriptive — it describes what RTIC operators must do, not what ALPR searches are limited to. No prior operational procedure for ALPR use has been identified. The procedure is not linked from the department's License Plate Readers page [33] — it was found only through the city's site-wide search.
...
| 32 | PRA W012320-031126 — Search activity compliance and audit records (rolling production; next update 5/6/2026) | Requested quarterly search activity audit records under SOP 205 (end-user and operator), aggregate compliance counts (case number entry, justification verification), and external agency search counts. The request expressly stated that re-producing the Casazza sharing-configuration memos would not be responsive. Response (4/22/2026): "At this time there are no responsive records to your request." Earlier responses (3/17/2026, 4/8/2026) pointed back to the Casazza memos as "all audit records maintained by the Department" and invoked § 7923.600 and § 1798.90.55(b) to decline the aggregate counts. Confirms no search activity compliance audit has ever been conducted; sharing-configuration memos are the only audit records that exist. [PRA response](https://github.com/none-below/sm-alpr/blob/main/assets/san-mateo-public-records/W012320-031126/W012320-031126_Message_History.pdf) |
| 33 | Wayback Machine snapshots — SMPD License Plate Readers page (Mar 16 and Apr 3, 2026) | Archived snapshots of cityofsanmateo.org/3211/License-Plate-Readers. Page links to full policy manual (not standalone Policy 463). SOP 205 not posted. No mention of Flock by name. Unchanged between snapshots. [Wayback Mar 16](https://web.archive.org/web/20260316184149/https://www.cityofsanmateo.org/3211/License-Plate-Readers) · [Wayback Apr 3](https://web.archive.org/web/20260403040858/https://www.cityofsanmateo.org/3211/License-Plate-Readers) |
| 34 | PRA W012373-032026 — Pre-MSA Flock contract (rolling production; Apr 22 update) | Item 1 requested any contract, agreement, MOU, or written authorization between SMPD and Flock in effect between November 2022 (first Flock invoice) and August 25, 2023 (MSA execution). Produced: Flock Group Inc. Services Agreement Order Form — "San Mateo PD - Phase 1." 12 cameras, $24,000/year, 24-month initial term with 12-month renewal. Signed by Garrett Langley (Flock CEO, 07/29/2020) and Lt. Todd Mefford (SMPD, 08/17/2020). Document Ref: N4JAT-XUHHU-6AJ2L-VWSQC. This agreement predates the August 2023 MSA by three years and does not appear in any Council agenda as an approval item. The Apr 22 response confirmed the 2020 Service Agreement is the only record responsive to Item 1 — no bridge contract, amendment, or extension was produced for the gap period. Item 2 (written authorization for deployment/operation): "At this time there are no responsive records to your request." Rolling email search continues; next update no later than 5/6/2026. [Service Agreement](https://github.com/none-below/sm-alpr/blob/main/assets/san-mateo-public-records/W012373-032026/Flock_Service_Agreement.pdf) · [PRA response](https://github.com/none-below/sm-alpr/blob/main/assets/san-mateo-public-records/W012373-032026/W012373-032026_Message_History.pdf) |
| 35 | Council Special Meeting — Goal Setting, Jan 29, 2022 | Meeting ID 1065, p. 7. Status column for Objective 21A reports: "22 Flock ALPRs deployed at strategic locations throughout the City resulting in 123 cases where police action was initiated based on data." Confirms 22 cameras operational by January 2022 — 10 more than the 2020 contract's 12-camera scope, and 19 months before Council approved the MSA. [Packet](https://sanmateo.primegov.com/Public/CompiledDocument?meetingTemplateId=5139&compileOutputType=1) |
...
| 39 | SMPD Procedure 1102 — ALPR Systems (Lexipol, published Mar 6, 2026) | Prescriptive operational procedure for Real Time Information Center (RTIC) personnel on monitoring and using the ALPR system. Covers alert evaluation, call creation, license plate querying, and vehicle description searches. Directs RTIC personnel to use ALPR "when searching for vehicles associated to crimes or life or death emergencies" and to document matches as "possible plate matches only." Defines operator duties, not search restrictions. Published by Lexipol with SMPD permission. Not linked from the License Plate Readers page [33]; found via site search. [City of San Mateo search](https://www.cityofsanmateo.org/Search?searchPhrase=alpr&pageNumber=1&perPage=10&departmentId=-1#docaccess-c4abf9736382f33c3af42fe357a71952f875b4fbf36bfa9086a54a74424c4bfb) |
